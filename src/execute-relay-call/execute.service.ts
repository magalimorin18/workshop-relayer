...
export const executeTransaction = async (
  ...
  console.log("📥 Received request from Alice");
  ...
  console.log(" ");
  console.log("⏳ Sent transaction to the blockchain ...");
  ...
  console.log(" ");
  console.log(
    `🚀 https://explorer.execution.testnet.lukso.network/tx/${transactionHash}`
  );
